...
export default function PostContainer({ setOpen: setOpenPostContainer }: { setOpen: StateController<boolean>[1] }) {
			...
			">
				...
				">
					...
					<div className="right-side w-[10%] max-h-[300px]">
						<div className="close-button h-[20%] min-[2000px]:h-[22%] flex justify-center items-center" onClick={() => setOpenPostContainer(false)}>
