	...
	return (
		<>
			...
			<div className="post-container
				...
				mt-5 mb-5
				flex flex-col gap-1
				md:w-[80vh] md:mt-0 md:border md:border-gray-300 md:rounded-[20px] md:bg-(--leftpanel-maincontainer-clr)
				min-[2000px]:w-[65vh]!
			">
				<div className="content
					...
					flex flex-row
				">
					<div className="hidden md:block left-side w-auto p-[0_10px_0_10px] h-[300px]">
					...
					<div className="metadata w-full flex flex-col min-h-[310px]">
						<div className="author-section h-[50px] flex items-center gap-2 md:gap-0">
						...
						<div className="post-data min-h-[250px] w-[95%] flex flex-col self-center md:w-full">
					...
					<div className="hidden md:block right-side p-[0_10px_0_10px] max-h-[300px]">
				...
				<PostSectionTools extendedClass='md:p-5 w-full flex justify-between h-[60px]' inAction={true} actions={[() => addMedia(), () => openCloseTool("poll", undefined, true)] } />
			</div>
		</>
	)
}
